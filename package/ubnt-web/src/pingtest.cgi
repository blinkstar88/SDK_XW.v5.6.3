...
function validateManualIP(id,name,value) {
	...
	if (o.selectedIndex == 0) {
		return _validateNonZeroIP(value) || _validateIP6(value);
	}
	return true;
}
		...
		<div id="pt_content">
		  ...
		  <tr>
			...
			<table cellspacing="0" cellpadding="0" class="pingh">
				<tr>
					<td class="h" style="width: 180px;"><? echo dict_translate("Host Name"); ></td>
			...
			<tr>
				<td class="f" colspan="3">
					<? echo sprintf(
						dict_translate("msg_ping_stats|%s of %s packets received, %s lost"),
		  ...
		  <input type="button" id="ping" name="ping" value="<? echo dict_translate("Start")>" onClick="_runPing(this.form);">
		  </td>
		  </tr>
