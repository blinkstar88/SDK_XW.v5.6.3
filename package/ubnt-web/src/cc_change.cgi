...
<table border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td colspan="2" class="license">
			...
			<? echo dict_translate("license_agreement2|You must also read and agree to the terms of the UBIQUITI FIRMWARE LICENSE AGREEMENT in the link below before you can download or install or use the Ubiquiti airOS&#8482; Firmware. "); >
			</p>
		</td>
	</tr>
	<tr>
