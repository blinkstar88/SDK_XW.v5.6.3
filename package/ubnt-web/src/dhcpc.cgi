...
<script type="text/javascript" language="javascript" src="FULL_VERSION_LINK/js/jquery.ui.js"></script>
</head>
...
<script type="text/x-jquery-tmpl" id="dhcpcTmpl">
	...
	<tr><td style="vertical-align: top">
		...
		{{if gateway }}
		<div class="row">
			<span class="label"><? echo dict_translate("Gateway IP");>:</span>
...
<form enctype="multipart/form-data" action="<? echo $PHP_SELF; ?>" method="POST">
	<table cellspacing="0" cellpadding="0" align="center">
		...
		<tr>
			<td class="change"><input type="button" id="ctrl_refresh" class="ctrl" onClick="return dhcpcRefresh();" value=" <? echo dict_translate("Refresh"); > "></td>
		</tr>
	</table>
</form>
