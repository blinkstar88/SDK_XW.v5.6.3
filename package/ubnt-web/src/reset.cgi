...
if ($REQUEST_METHOD == "POST") {
    exec($cmd_cfgdef);
    $pagetitle = dict_translate("Reset to Factory Defaults");
...
$title = dict_translate("Reset to Factory Defaults");
$question = dict_translate("qst_reset_defaults|Do you really want to reset the device to its defaults?");
