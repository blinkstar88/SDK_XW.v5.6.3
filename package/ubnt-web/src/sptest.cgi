					...
					<td>
						<table cellspacing="0" cellpadding="0" class="st_opt">
							...
							<tr>
								...
								<td><input type="password" class="std_width" id="auth_password" name="auth_password" size="18" maxlength="128"></td>
							</tr>
							<tr>
							...
							<tr id="advanced2" style="display: none;">
								...
								<td><input class="std_width" type="text" id="time_limit" name="time_limit" value="30" size="2" maxlength="2" /> &nbsp;<? echo dict_translate("seconds");></td>
							</tr>
						</table>
					</td>
					<td id="st_results">
