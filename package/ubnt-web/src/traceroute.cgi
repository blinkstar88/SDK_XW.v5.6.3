	...
	<form name="traceroute" enctype="multipart/form-data" action="traceroute_action.cgi" method="POST" onSubmit="startTraceroute(this);return false;">
		...
		<div id="tr_content">
		  ...
		  <td colspan="5" align="center" style="vertical-align: top;">
		    ...
		    <td class="h" style="width: 170px;"><? echo dict_translate("Host Name"); ></td>
		  ...
		  <tr>
		    ...
		    <input type="button" id="tr_start" name="tr_start" value="<? echo dict_translate("Start")>" onClick="_traceroute(this.form);">
		    </td>
                  </tr>
		  </table>
		</div>
